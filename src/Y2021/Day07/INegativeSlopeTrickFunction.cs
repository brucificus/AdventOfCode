public interface INegativeSlopeTrickFunction<TSelf, out TCoefficient, TInput, TProduct, out TConstant, out TResult>
    :  ISlopeTrickFunction<TSelf, TCoefficient, TInput, TProduct, TConstant, TResult>
    where TCoefficient : IMultiplyOperators<TCoefficient, TInput, TProduct>, IAdditionOperators<TCoefficient, TCoefficient, TCoefficient>, IAdditiveIdentity<TCoefficient, TCoefficient>, IDecrementOperators<TCoefficient>
